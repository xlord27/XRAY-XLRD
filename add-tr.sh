...
trojanlink1="trojan://${uuid}@${domain}:443?type=ws&security=tls&host=${domain}&path=/funny&sni=${domain}#${user}"
trojanlink2="trojan://${uuid}@${domain}:80?type=ws&security=none&host=${domain}&path=/funy#${user}"
